...
Checkout [dev2](./dev2) or [dev3](./dev3)  for options of running the local version of Starship in Airflow 2 or Airflow 3 respectively.
...
# Airflow 3
just dev3 deploy mydeploymentid
```
